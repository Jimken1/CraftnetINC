...
const RESOLVE_DISPUTE_BUTTON_DEFAULT_HTML = '<i class="fas fa-check"></i> Resolve Dispute';
...
function openResolveModal(disputeId) {
    ...
    const submitButton = document.getElementById('resolve-dispute-submit-btn');
    if (modal) {
        ...
        if (submitButton) {
            ...
            submitButton.innerHTML = RESOLVE_DISPUTE_BUTTON_DEFAULT_HTML;
